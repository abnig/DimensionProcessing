...
public class BeanConfig {
	...
	@Bean(name = "hashFileMetadataBlockingQueue")
	public BlockingQueue<HashFileMetadata> hashFileMetadataBlockingQueue() {
		return new LinkedBlockingQueue<HashFileMetadata>();
	}
