...
public class InsertOperationMetadataService extends AbstractInsertOperationMetadataService implements InsertOperationService, InitializingBean {
	...
	public Job instantiateInsertOperationBatchJob(InsertOperationMetadata insertOperationMetadata) {
		String name = "DimensionProcessing_SourceTable_" + insertOperationMetadata.getDimensionMetadata().getSourceTable();
		try {
	...
	public InsertOperationMetadata generateInsertOperationBatchJobMetadata(DimensionMetadata dimensionMetadata,
		...
		logger.info("LOAD Query to create file for insert operation: " + insertSQL.toString());
